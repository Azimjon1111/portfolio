          ...
          <div className="flex flex-wrap text-center lg:text-left">
            <div className="w-full lg:w-6/12 px-4">
              ...
              <div className="mt-6 lg:mb-0 mb-6">
                <Link href="https://t.me/developer_uzz">
                <button
                ...
                <Link href="https://www.facebook.com/azimjon.bekmuratov">
                <button
                ...
                <Link href="https://www.instagram.com/01_azimjon/">
                <button
                ...
                <Link href="https://github.com/Azimjon1111">
                <button
